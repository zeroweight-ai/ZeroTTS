...
Generated by the model below. GitHub does not play audio inline, so these
download — the [model card](https://huggingface.co/zeroweight-ai/ZeroTTS#samples)
plays the same clips in the page.

- 🔊 [Two-speaker conversation](https://raw.githubusercontent.com/zeroweight-ai/ZeroTTS/main/docs/samples/conversation.mp3)
- 🔊 [Long-form narration](https://raw.githubusercontent.com/zeroweight-ai/ZeroTTS/main/docs/samples/storytelling.mp3)
- 🔊 [News read, code-switched English](https://raw.githubusercontent.com/zeroweight-ai/ZeroTTS/main/docs/samples/news-code-switch.mp3)
- 🔊 Cross-lingual: [Vietnamese reference](https://raw.githubusercontent.com/zeroweight-ai/ZeroTTS/main/docs/samples/cross-lingual-reference-vi.mp3) → [English output](https://raw.githubusercontent.com/zeroweight-ai/ZeroTTS/main/docs/samples/cross-lingual-english.mp3)
